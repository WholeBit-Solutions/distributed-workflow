...
{
    internal sealed class ContactWorker(IConsumer<int, ContactInfo> consumer, IPersonWorkflow messageWorkflow) : BackgroundService
    {
        public override Task StartAsync(CancellationToken cancellationToken)
        {
            consumer.Subscribe("contact-topic");
